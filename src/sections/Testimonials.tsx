    ...
    <section className="py-20 bg-gradient-to-b from-gray-900 to-black">
      <div className="container mx-auto px-4 lg:px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          <Card className="bg-black border-2 border-gold/30 hover:border-gold transition-all duration-300 hover:shadow-lg hover:shadow-gold/20">
            <CardContent className="p-6">
              ...
              <div className="border-t border-gold/20 pt-4">
                <p className="text-gold font-semibold">Marie Dubois</p>
          ...
          <Card className="bg-black border-2 border-gold/30 hover:border-gold transition-all duration-300 hover:shadow-lg hover:shadow-gold/20">
            <CardContent className="p-6">
              ...
              <div className="border-t border-gold/20 pt-4">
                <p className="text-gold font-semibold">Thomas Martin</p>
          ...
          <Card className="bg-black border-2 border-gold/30 hover:border-gold transition-all duration-300 hover:shadow-lg hover:shadow-gold/20">
            <CardContent className="p-6">
              ...
              <div className="border-t border-gold/20 pt-4">
                <p className="text-gold font-semibold">Sophie Leroy</p>
